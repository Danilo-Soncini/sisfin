                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <c:forEach items="${Categories}" var="category"> 
                                       <tr>
                                            ...
                                            <td>${category.entrece}</td>
                                            <td>
                                                <a class="btn btn-primary pull-right" href="/financeiro/category/edit?id=${category.id}">Editar</a>
                                            </td>
                                        </tr>
                                    </c:forEach>   
                                ...
                                <a class="btn btn-primary pull-right" href="/financeiro/category/new">Novo</a>
                            </div>
                        </div>
                    </div>
